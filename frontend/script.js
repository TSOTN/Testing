  ...
  try {
    ...
    if (posts.length === 0) {
      ...
      posts = [
        ...
        { author: '@PixelFan', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=4', timestamp: 'Hace 1d', frontImg: 'https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1888930/header.jpg', frontTitle: 'The Last of Us Part I', frontDesc: 'Un viaje brutal y emotivo a través de un mundo post-apocalíptico.', backImg: 'https://m.media-amazon.com/images/M/MV5BMTQ5OTcwNDA4M15BMl5BanBnXkFtZTcwODEzMTgwOQ@@._V1_.jpg', backTitle: 'Children of Men', backDesc: 'La humanidad al borde de la extinción y la esperanza en una persona.', liked: false, likes: 832, comments: 211 },
        { author: '@GamerCinefilo', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=5', timestamp: 'Hace 2d', frontImg: 'https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2215430/header.jpg', frontTitle: 'Ghost of Tsushima', frontDesc: 'Conviértete en el Fantasma para salvar a tu isla de la invasión mongola.', backImg: 'https://m.media-amazon.com/images/M/MV5BZmMyNGE2MTQtZTEzZC00OTg5LWE0ZGEtMzg4NzA5Njc0MTBjXkEyXkFqcGc@._V1_.jpg', backTitle: 'Seven Samurai', backDesc: 'La obra maestra de Akira Kurosawa sobre el honor y el sacrificio.', liked: true, likes: 1045, comments: 154 },
        { author: '@HorrorFan', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=6', timestamp: 'Hace 2d', frontImg: 'https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2050650/header.jpg', frontTitle: 'Resident Evil 4', frontDesc: 'Sobrevive a las hordas infectadas en una aldea remota.', backImg: 'https://m.media-amazon.com/images/M/MV5BMTQ1MDc3MzIzNV5BMl5BanBnXkFtZTcwMjA3MzkxMQ@@._V1_.jpg', backTitle: 'Dawn of the Dead', backDesc: 'Un clásico de zombis y supervivencia con un ritmo frenético.', liked: false, likes: 423, comments: 67 },
        { author: '@SciFiGeek', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=7', timestamp: 'Hace 3d', frontImg: 'https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/7670/header.jpg', frontTitle: 'BioShock', frontDesc: 'Explora la distópica y sumergida ciudad de Rapture.', backImg: 'https://m.media-amazon.com/images/M/MV5BMTQ3NzA1NDY3MV5BMl5BanBnXkFtZTgwNzY2NDUzMTE@._V1_.jpg', backTitle: 'Snowpiercer', backDesc: 'Lucha de clases en un tren distópico y claustrofóbico.', liked: true, likes: 789, comments: 92 },
        ...
        { author: '@Tarnished', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=12', timestamp: 'Hace 6d', frontImg: 'https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1245620/header.jpg', frontTitle: 'Elden Ring', frontDesc: 'Un majestuoso viaje de fantasía oscura para restaurar el Círculo de Elden.', backImg: 'https://m.media-amazon.com/images/M/MV5BMjM1MTYxNDEtOGU4OC00OTlhLTllNDgtMDliZDRhOGIyYTAzXkEyXkFqcGdeQXVyMDM2NDM2MQ@@._V1_.jpg', backTitle: 'The Green Knight', backDesc: 'Caballería, mitos artúricos oscuros y un mundo lleno de misticismo.', liked: false, likes: 3421, comments: 512 }
      ];
    }
    renderFeed();
